...
public:
    ...
    std::uintptr_t reset;
    MemAlloc* memalloc;
    GameCoordinator* steamGameCoordinator;
    std::uint8_t* fakePrime;
    std::uintptr_t isLoadoutAllowed;
    ...
    void(__fastcall* initSafeModule)(void*, void*);
    ...
    std::uintptr_t isSecureServerAllowed;
    std::uintptr_t disableAllowSecuredServers;
#else
