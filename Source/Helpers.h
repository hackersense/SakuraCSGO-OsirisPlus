...
namespace Helpers
{
    ...
    constexpr auto bronzeEventCoinFromViewerPass(WeaponId id) noexcept
    {
        ...
        case WeaponId::Rio2022ViewerPass:
        case WeaponId::Rio2022ViewerPassWith3Tokens: return WeaponId::Rio2022BronzeCoin;
        case WeaponId::Paris2023ViewerPass:
        case WeaponId::Paris2023ViewerPassWith3Tokens: return WeaponId::Paris2023BronzeCoin;
