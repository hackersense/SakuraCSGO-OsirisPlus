...
{
    if (ImGui::MenuItem(Language::getText(LanguageID::GUI_TAB_GLOW))) {
        glowWindowOpen = true;
        ImGui::SetWindowFocus(Language::getText(LanguageID::GUI_TAB_GLOW));
        ImGui::SetWindowPos(Language::getText(LanguageID::GUI_TAB_GLOW), { 100.0f, 100.0f });
    }
}

void Glow::tabItem() noexcept
{
    if (ImGui::BeginTabItem(Language::getText(LanguageID::GUI_TAB_GLOW))) {
        drawGUI(true);
        ImGui::EndTabItem();
    }
}
...
void Glow::drawGUI(bool contentOnly) noexcept
{
    if (!contentOnly) {
        ...
        ImGui::Begin(Language::getText(LanguageID::GUI_TAB_GLOW), &glowWindowOpen, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
    }
