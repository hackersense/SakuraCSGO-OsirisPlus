...
{
    if (ImGui::BeginTabItem(Language::getText(LanguageID::GUI_TAB_SOUND))) {
        drawGUI(true);
        ImGui::EndTabItem();
    }
}
...
{
    if (ImGui::MenuItem(Language::getText(LanguageID::GUI_TAB_SOUND))) {
        soundWindowOpen = true;
        ImGui::SetWindowFocus(Language::getText(LanguageID::GUI_TAB_SOUND));
        ImGui::SetWindowPos(Language::getText(LanguageID::GUI_TAB_SOUND), { 100.0f, 100.0f });
    }
}
...
void Sound::drawGUI(bool contentOnly) noexcept
{
    if (!contentOnly) {
        ...
        ImGui::Begin(Language::getText(LanguageID::GUI_TAB_SOUND), &soundWindowOpen, ImGuiWindowFlags_NoCollapse | ImGuiWindowFlags_NoResize | ImGuiWindowFlags_NoScrollbar | ImGuiWindowFlags_NoScrollWithMouse);
    }
