...
public:
    ...
    VIRTUAL_METHOD(void, drawBeam, WIN32_LINUX(6, 3), (Beam* beam), (this, std::ref(beam)))
    VIRTUAL_METHOD(Beam*, createBeamPoints, WIN32_LINUX(12, 9), (BeamInfo& beamInfo), (this, std::ref(beamInfo)))
    VIRTUAL_METHOD(Beam*, createBeamRing, WIN32_LINUX(14, 11), (BeamInfo& beamInfo), (this, std::ref(beamInfo)))
    VIRTUAL_METHOD(Beam*, createBeamRingPoints, WIN32_LINUX(16, 13), (BeamInfo& beamInfo), (this, std::ref(beamInfo)))
};
